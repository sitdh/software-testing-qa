...
\lstdefinestyle{sitdhcodelistinginstruemented}{
    frame=trBL,
    label=trianglecheckinstrumented,
    showspaces=false,
    numberstyle=\tiny, 
    language=Java, 
    numbers=left,   
...
\lstinputlisting[style=sitdhcodelistinginstruemented, title=\lstname, caption=โปรแกรมตรวจสอบรูปสามเหลี่ยมภาษา JavaScript - Instruemented]{src/compute-instrumented.js}
