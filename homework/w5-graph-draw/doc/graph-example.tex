...
\begin{table}[hb!]
    ...
    \begin{center}
        ...
        \begin{tabular}[p]{ | c | l | *{6}{c|} l |}
            \hline
            \multirow{2}{*}{ID} & \multicolumn{1}{c}{\multirow{2}{*}{Path}} & \multicolumn{3}{|c|}{Decision} & \multicolumn{3}{|c|}{Input} & \multicolumn{1}{c|}{\multirow{2}{*}{Expected Output}} \\ \cline{3-8}
                               & & 5 & 6 & 8 & a & b & c & \\ \hline
