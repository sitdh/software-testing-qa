...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item โปรแกรมจะแยกออกเป็น 2 โฟลเดอร์ ได้แก่
            \begin{enumerate}
                \item {\bf normal} สำหรับโค้ดที่ใช้วาด Control Flow Graph แบบปรกติ
                \item {\bf instrumented} สำหรับตรวจสอบการทำงานของ Test case
            \end{enumerate}
        \item ไฟล์ JavaScript ที่พัฒนาขึ้นมานี้ จะอยู่ที่โฟลเดอร์ normal/asset/js/bundle.js และ instrumented/asset/js/bundle.js สำหรับโค้ดแบบปรกติ และโค้ดที่ทำ Instrument แล้ว ตามลำดับ \label{enu:js}
        \item โค้ดที่นำมาแสดงใน \numbername~\ref{sec:trianglecal}~{\bf \titleref{sec:trianglecal}} คือโค้ดที่มาจากไฟล์ {\bf normal/asset/js/bundle.js} แต่ตัดช่องว่างระหว่างบรรทัดออก เพื่อให้วาด Control Flow Graph ได้กระชับมากยิ่งขึ้น
        \item วิธีการเรียกใช้งานทำได้ด้วยการเปิดไฟล์ {\bf index.html} ที่อยู่ภายในชั้นบนสุดของโฟลเดอร์ที่สนใจ ผ่านเบราว์เซอร์ที่รองรับ
            \begin{enumerate}
